  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        <motion.div style={{ x: parallaxX1, y: parallaxY1 }} initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true }} className="absolute top-10 left-10">
          <RocketImage className="w-48 h-auto opacity-10 dark:opacity-40" />
        </motion.div>
        <motion.div style={{ x: parallaxX2, y: parallaxY2 }} initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.3 }} viewport={{ once: true }} className="absolute -bottom-20 -right-20">
          <FunnelImage className="w-64 h-auto opacity-5 dark:opacity-20" />
        </motion.div>
        <motion.div style={{ x: parallaxX3, y: parallaxY3 }} initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.4 }} viewport={{ once: true }} className="absolute top-1/3 left-[20%]">
          <ResultadoImage className="w-32 h-auto opacity-5 dark:opacity-25" />
        </motion.div>
        <motion.div style={{ x: parallaxX4, y: parallaxY4 }} initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.5 }} viewport={{ once: true }} className="absolute top-10 right-10">
        ...
        <motion.div style={{ x: parallaxX5, y: parallaxY5 }} initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.6 }} viewport={{ once: true }} className="absolute bottom-1/4 left-[5%]">
          <LemonImage className="w-24 h-auto opacity-10 dark:opacity-30" />
        </motion.div>
        <motion.div style={{ x: parallaxX6, y: parallaxY6 }} initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.7 }} viewport={{ once: true }} className="absolute top-1/4 right-[5%]">
          <ResultadoImage className="w-40 h-auto opacity-5 dark:opacity-20" />
        </motion.div>
      </div>
